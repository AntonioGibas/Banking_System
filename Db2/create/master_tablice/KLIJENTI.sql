...
CREATE TABLE KLIJENTI (
    ...
    DATUM_KREIRANJE     TIMESTAMP       NOT NULL WITH 
     DEFAULT CURRENT TIMESTAMP,
    ZADNJE_AZURIRANJE   TIMESTAMP       NOT NULL WITH 
     DEFAULT CURRENT TIMESTAMP,
    ...
    CONSTRAINT FK_KLIJENT_POSLOVNICA FOREIGN KEY 
     (POSLOVNICA_KREIRANJE) REFERENCES POSLOVNICE (POSLOVNICA_KOD),
